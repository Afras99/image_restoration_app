...
if __name__ == "__main__":
    ...
    os.chdir("image_restoration/./Global")
    ...
    input_dir = os.path.join(opts.output_folder, "final_output")
    output_dir = os.path.join(opts.output_folder, "super_resolution_output")
